package com.fleetManagement.app.commun;
...
public class CoreConstant {
	...
	public static class Exception {
        ...
        public static final String VEHICLE_ALREADY_IN_USE = "message.exception.vehicle.already.in.use";
        public static final String DRIVER_ALREADY_IN_USE = "message.exception.driver.already.in.use";
        public static final String VEHICLE_LICENSE_TYPE_NOT_MATCH = "message.exception.vehicle.license.type.not.match";
        public static final String DRIVER_LICENSE_TYPE_NOT_MATCH = "message.exception.driver.license.type.not.match";
